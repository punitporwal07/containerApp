...
RUN curl -O https://downloads.apache.org/tomcat/tomcat-8/v8.5.57/bin/apache-tomcat-8.5.57.tar.gz && tar -xpzf apache-tomcat-8.5.57.tar.gz && rm -rf apache-tomcat-8.5.57.tar.gz
